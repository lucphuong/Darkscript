...
local tonghopButton = MainTab:CreateButton({
   Name = "tổng hợp key là acquyfflaso1",
   Callback = function()
   loadstring(game:HttpGet("https://raw.githubusercontent.com/Hahahsjdoroteodch/HoangAnh/refs/heads/main/tonghopvip.lua"))()
      end
})
